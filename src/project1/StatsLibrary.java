...
public class StatsLibrary {
	...
	/**
	 * 
	 * @param inputNumbers is the list of double type numbers
	 ...
	 * @return the standard deviation of the list Uses {@link #findMean(ArrayList<Double>) findMean} to
	 *         calculate the mean
	...
	/**
	 * 
	 * @param listA is the subset A containing integer elements
	 * @param listB is the subset B containing integer elements
	...
	/**
	 * 
	 * @param inputList is a list containing integer elements.
	 * @param inputSet  is a list containing integer elements.
	...
	/**
	 * 
	 * @param inputNum is the integer type number being input.
	 ...
	 * @return The combination of n and r. Uses {@link #factorial(int)} to
	 ...
	 * @param n is the first integer type number being input
	 * @param r is the second integer type number being input
	 * @return the permutation of n and r Uses {@link #factorial(int)} to
	 *         calculate the factorial
	 * @see <a href=
	 *      "https://www.geeksforgeeks.org/biginteger-class-in-java/">BigInteger
	 *      source</a>
	...
	/**
	 * 
	 * @param n is the integer type number of trials
	 * @param y is the integer type number of successes
	 * @param p is the double type probability of a successful trial
